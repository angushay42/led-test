...
# ------ added code -------
BIN_DIR ?= bin		# edited to put .elf executable into /bin
# ------ end added -----

BUILD_DIR ?= build	# edited to put .o and .d files into /build
OPT ?= -Os
CSTD ?= -std=c99
...
GENERATED_BINS = $(BIN_DIR)/$(PROJECT).elf $(BIN_DIR)/$(PROJECT).bin $(BIN_DIR)/$(PROJECT).map $(BIN_DIR)/$(PROJECT).list $(BIN_DIR)/$(PROJECT).lss
...
$(BIN_DIR)/$(PROJECT).elf: $(OBJS) $(LDSCRIPT) $(LIBDEPS)
	@printf "  LD\t$@\n"
